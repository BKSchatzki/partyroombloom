import { buildTreeFromFlat } from './outlineTransformers';
import { Element, Outline } from './types';

export const tutorialOutlineElementsFlat: Element[] = [
  {
    id: 'landmark0',
    parentId: null,
    type: 'landmark',
...
export const tutorialOutlineFinal: Outline = {
  ...
  elements: buildTreeFromFlat(tutorialOutlineElementsFlat),
  conversations: [],
};
