...
export default async function Home() {
  ...
  return (
    <Container className="max-w-[72rem] gap-16">
      <div className="flex w-full flex-col items-center text-balance bg-gradient-to-b from-base-300 to-transparent py-16 text-center">
